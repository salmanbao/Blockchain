...
<div class="row">
	<div class="col-sm-4"> 
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo1'))
	</div>
	<div class="col-sm-4"> 
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo2'))
	</div>
	<div class="col-sm-4">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo3'))
	</div>
</div> 
<div class="row">
	<div class="col-sm-4">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo4'))
	</div>
	<div class="col-sm-4">
		...
		<h4>Right Aligned Blockquote</h4>
		 ...
		 @endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo5'))
	</div>
	<div class="col-sm-4">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo6'))
	</div>
</div> 
<div class="row">
	<div class="col-sm-4">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo7'))
	</div>
	<div class="col-sm-4">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'typo8'))
	</div>
</div>	
</div>
@stop