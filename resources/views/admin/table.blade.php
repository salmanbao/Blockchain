...
<div class="row">
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'table'))
	</div>
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'btable'))
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
	@section ('stable_panel_title','Striped Table')
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'stable'))
	</div>
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'htable'))
	</div>
</div>
...
<div class="row">
	...
	@section ('ctable_panel_title','Condensed Table')
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'ctable'))
	</div>
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'atable'))
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'cotable'))
	</div>
</div>
</div>
@stop