...
<div class="row">
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('controls'=>true, 'as'=>'progress'))
	</div>
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('controls'=>true, 'header'=>true, 'as'=>'cprogress'))
	</div>
</div>
...
<div class="rpw">
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('controls'=>true, 'header'=>true, 'as'=>'sprogress'))
	</div>
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('controls'=>true, 'as'=>'stprogress'))
	</div>
</div>
@stop