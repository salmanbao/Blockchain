...
@section('section')
		...
		@section ('dpanel_panel_body')
			...
			@endsection
			@include('admin.widgets.panel', array('header'=>true, 'as'=>'inside'))
		@endsection	
...
<i class="fa fa-at"></i>include('admin.widgets.panel', array('header'=>true, 'as'=>'inside'))
		...
		@endsection
		@include ('admin.widgets.panel', array('class'=>'primary', 'header'=>true, 'footer'=>true, 'as'=>'dpanel'))
...
<i class="fa fa-at"></i>include('widgets.collapse', array('id'=>'2', 'header'=> 'This is a header', 'body'=>'Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo.'))
		...
		@endsection
		@include ('admin.widgets.panel', array('class'=>'primary', 'header'=>true, 'footer'=>true, 'as'=>'dcollapsible'))
...
<i class="fa fa-at"></i>include('admin.widgets.button', array('class'=>'success btn-outline', 'value'=>'Primary'))
		...
		@endsection
		@include ('admin.widgets.panel', array('class'=>'primary', 'header'=>true, 'footer'=>true, 'as'=>'dbutton'))
...
<i class="fa fa-at"></i>include('admin.widgets.alert', array('class'=>'info', 'dismissable'=>true, 'message'=> 'My message'))
		...
		@endsection
		@include ('admin.widgets.panel', array('class'=>'primary', 'header'=>true, 'footer'=>true, 'as'=>'doalert'))
...
<i class="fa fa-at"></i>include('admin.widgets.progress', array('class'=> 'danger', 'value'=>'12', 'badge'=>true))
		...
		@endsection
		@include ('admin.widgets.panel', array('class'=>'primary', 'header'=>true, 'footer'=>true, 'as'=>'dprogress'))
