...
@section('section')
	...
	@endsection
@include('admin.widgets.panel', array('header'=>true, 'as'=>'alert1'))
<div class="row">
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'alert3'))
	</div>
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'alert2'))
	</div>
</div>
@stop
