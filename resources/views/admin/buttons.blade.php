...
@section('section')
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('as'=>'5button', 'header'=>true))
	</div>
	...
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('as'=>'6button', 'header'=>true))
		...
		@endsection
		@include('admin.widgets.panel', array('as'=>'9button', 'header'=>true))
