	...
	<div class="col-sm-12">
		...
		<div class="row">
			<div class="fa col-lg-3">
				...
				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-o-down')) fa-arrow-circle-o-down

				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-o-up')) fa-arrow-circle-o-up
				...
				<p>@include('admin.widgets.icon', array('class'=>'exclamation-circle')) fa-exclamation-circle
				...
				<p>@include('admin.widgets.icon', array('class'=>'exclamation-triangle')) fa-exclamation-triangle
			...
			<div class="fa col-lg-3">
				...
				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-left')) fa-arrow-circle-left

				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-right')) fa-arrow-circle-right

				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-up')) fa-arrow-circle-up

				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-down')) fa-arrow-circle-down
				...
				<p>@include('admin.widgets.icon', array('class'=>'pinterest-square')) fa-pinterest-square

				<p>@include('admin.widgets.icon', array('class'=>'google-plus-square')) fa-google-plus-square
			...
			<div class="fa col-lg-3">
				<p>@include('admin.widgets.icon', array('class'=>'angle-double-left')) fa-angle-double-left

				<p>@include('admin.widgets.icon', array('class'=>'angle-double-right')) fa-angle-double-right

				<p>@include('admin.widgets.icon', array('class'=>'angle-double-up')) fa-angle-double-up

				<p>@include('admin.widgets.icon', array('class'=>'angle-double-down')) fa-angle-double-down
				...
				<p>@include('admin.widgets.icon', array('class'=>'microphone-slash')) fa-microphone-slash
				...
				<p>@include('admin.widgets.icon', array('class'=>'fire-extinguisher')) fa-fire-extinguisher

				<p>@include('admin.widgets.icon', array('class'=>'rocket')) fa-rocket

				<p>@include('admin.widgets.icon', array('class'=>'maxcdn')) fa-maxcdn

				<p>@include('admin.widgets.icon', array('class'=>'chevron-circle-left')) fa-chevron-circle-left

				<p>@include('admin.widgets.icon', array('class'=>'chevron-circle-right')) fa-chevron-circle-right

				<p>@include('admin.widgets.icon', array('class'=>'chevron-circle-up')) fa-chevron-circle-up

				<p>@include('admin.widgets.icon', array('class'=>'chevron-circle-down')) fa-chevron-circle-down
				...
				<p>@include('admin.widgets.icon', array('class'=>'external-link-square')) fa-external-link-square
				...
				<p>@include('admin.widgets.icon', array('class'=>'caret-square-o-down')) fa-caret-square-o-down

				<p>@include('admin.widgets.icon', array('class'=>'toggle-up')) fa-toggle-up

				<p>@include('admin.widgets.icon', array('class'=>'caret-square-o-up')) fa-caret-square-o-up

				<p>@include('admin.widgets.icon', array('class'=>'toggle-right')) fa-toggle-right

				<p>@include('admin.widgets.icon', array('class'=>'caret-square-o-right')) fa-caret-square-o-right
				...
				<p>@include('admin.widgets.icon', array('class'=>'sort-amount-desc')) fa-sort-amount-desc

				<p>@include('admin.widgets.icon', array('class'=>'sort-numeric-asc')) fa-sort-numeric-asc

				<p>@include('admin.widgets.icon', array('class'=>'sort-numeric-desc')) fa-sort-numeric-desc
				...
				<p>@include('admin.widgets.icon', array('class'=>'bitbucket-square')) fa-bitbucket-square
			...
			<div class="fa col-lg-3">
				...
				<p>@include('admin.widgets.icon', array('class'=>'long-arrow-right')) fa-long-arrow-right
				...
				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-o-right')) fa-arrow-circle-o-right

				<p>@include('admin.widgets.icon', array('class'=>'arrow-circle-o-left')) fa-arrow-circle-o-left

				<p>@include('admin.widgets.icon', array('class'=>'toggle-left')) fa-toggle-left

				<p>@include('admin.widgets.icon', array('class'=>'caret-square-o-left')) fa-caret-square-o-left
				...
				<p>@include('admin.widgets.icon', array('class'=>'stumbleupon-circle')) fa-stumbleupon-circle
				...
				<p>@include('admin.widgets.icon', array('class'=>'pied-piper-square')) fa-pied-piper-square
				...
				<p>@include('admin.widgets.icon', array('class'=>'file-powerpoint-o')) fa-file-powerpoint-o
				...
				<p>@include('admin.widgets.icon', array('class'=>'share-alt-square')) fa-share-alt-square
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'icons'))
