...
@section('section')
	<div class="col-sm-6">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'panel1'))
		...
		Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
		 ...
		 proident, sunt in culpa qui officia deserunt mollit anim id est laborum. 
		@endsection
		@include('admin.widgets.panel', array('class'=>'primary', 'header'=>true, 'as'=>'panel2'))
		...
		@include('admin.widgets.panel', array('class'=>'success', 'header'=>true, 'footer'=>true, 'as'=>'panel3'))
	</div>
	<div class="col-sm-6">
		...
		proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
		@endsection
		@include('admin.widgets.panel', array('class'=>'info', 'header'=> true, 'as'=>'panel4'))
		...
		proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
		@endsection
		@include('admin.widgets.panel', array('class'=>'warning', 'header'=>true, 'as'=>'panel5'))
		...
		proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
		@endsection
		@include('admin.widgets.panel', array('class'=>'danger', 'header'=>true, 'as'=>'panel6'))
	</div>
	<div class="col-sm-12">
		...
		@endsection
		@include('admin.widgets.panel', array('header'=>true, 'as'=>'collapsible'))
	</div>
@stop